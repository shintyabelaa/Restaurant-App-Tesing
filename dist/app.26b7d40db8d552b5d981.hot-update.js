...
const createRestaurantListTemplate = (restaurant) => `
  <div id="restaurant-item">
    ...
    <div class="restaurant-list__content">
      <a href="/#/detail/${restaurant.id}"><h3>${restaurant.name}</a></h3>
