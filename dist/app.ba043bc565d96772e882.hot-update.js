...
const createRestaurantDetailTemplate = (restaurant) => `
    ...
    <img class="restaurant__image" src="${restaurant.pCONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name}" />${restaurant.pictureId ? _globals_config__WEBPACK_IMPORTED_MODULE_0__["default"].BASE_IMAGE_URL + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}"
